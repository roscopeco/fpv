...
fields[2] = { t = "Center",     x = x + indent, y = incY(lineSpacing), sp = x + sp, preEdit = onPreEditCenter, change = onChangeCenter, postEdit = onPostEditCenter }
fields[3] = { t = "Min",        x = x + indent, y = incY(lineSpacing), sp = x + sp }
fields[4] = { t = "Max",        x = x + indent, y = incY(lineSpacing), sp = x + sp }
fields[5] = { t = "Scale neg",  x = x + indent, y = incY(lineSpacing), sp = x + sp }
fields[6] = { t = "Scale pos",  x = x + indent, y = incY(lineSpacing), sp = x + sp }
fields[7] = { t = "Rate",       x = x + indent, y = incY(lineSpacing), sp = x + sp }
