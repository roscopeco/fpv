...
fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), w = 50, data = pids[0] }
fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), w = 50, data = pids[4] }
fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), w = 50, data = pids[8] }

x = x + colSpacing
y = tableStartY
labels[#labels + 1] = { t = "I",     x = x, y = incY(tableSpacing.header) }
fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), w = 50, data = pids[1] }
fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), w = 50, data = pids[5] }
fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), w = 50, data = pids[9] }

x = x + colSpacing
y = tableStartY
labels[#labels + 1] = { t = "D",     x = x, y = incY(tableSpacing.header) }
fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), w = 50, data = pids[2] }
fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), w = 50, data = pids[6] }
fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), w = 50, data = pids[10] }

x = x + colSpacing
y = tableStartY
labels[#labels + 1] = { t = "FF",    x = x, y = incY(tableSpacing.header) }
fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), w = 50, data = pids[3] }
fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), w = 50, data = pids[7] }
fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), w = 50, data = pids[11] }

x = x + colSpacing
y = tableStartY
labels[#labels + 1] = { t = "B",     x = x, y = incY(tableSpacing.header) }
fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), w = 50, data = pids[12] }
fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), w = 50, data = pids[13] }
fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), w = 50, data = pids[14] }
...
fields[#fields + 1] = { t = "Roll",                   x = x + indent, y = incY(lineSpacing), sp = x + sp, data = pids[15] }
fields[#fields + 1] = { t = "Pitch",                  x = x + indent, y = incY(lineSpacing), sp = x + sp, data = pids[16] }
