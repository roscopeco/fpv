...
fields[#fields + 1] = { t = "Geo correction",           x = x + indent, y = incY(lineSpacing), sp = x + sp, data = mixerConfig.swash_geo_correction }
fields[#fields + 1] = { t = "Total pitch limit",        x = x + indent, y = incY(lineSpacing), sp = x + sp, data = mixerConfig.swash_pitch_limit }
fields[#fields + 1] = { t = "Phase angle",              x = x + indent, y = incY(lineSpacing), sp = x + sp, data = mixerConfig.swash_phase }
...
fields[#fields + 1] = { t = "Roll trim",                x = x + indent, y = incY(lineSpacing), sp = x + sp, data = mixerConfig.swash_trim_roll }
fields[#fields + 1] = { t = "Pitch trim",               x = x + indent, y = incY(lineSpacing), sp = x + sp, data = mixerConfig.swash_trim_pitch }
fields[#fields + 1] = { t = "Coll. trim",               x = x + indent, y = incY(lineSpacing), sp = x + sp, data = mixerConfig.swash_trim_collective }

incY(lineSpacing * 0.25)
labels[#labels + 1] = { t = "Motorised Tail",           x = x,          y = incY(lineSpacing) }
fields[#fields + 1] = { t = "Motor idle thrott",        x = x + indent, y = incY(lineSpacing), sp = x + sp, data = mixerConfig.tail_motor_idle }
fields[#fields + 1] = { t = "Center trim",              x = x + indent, y = incY(lineSpacing), sp = x + sp, data = mixerConfig.tail_center_trim }
