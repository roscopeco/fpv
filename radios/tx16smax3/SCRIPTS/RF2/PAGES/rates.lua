...
local function buildForm()
    ...
    fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), data = rcTuning[0] }
    fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), data = rcTuning[3] }
    fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), data = rcTuning[6] }
    fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), data = rcTuning[9] }
    ...
    fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), data = rcTuning[2] }
    fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), data = rcTuning[5] }
    fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), data = rcTuning[8] }
    fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), data = rcTuning[11] }
    ...
    fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), data = rcTuning[1] }
    fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), data = rcTuning[4] }
    fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), data = rcTuning[7] }
    fields[#fields + 1] = {              x = x, y = incY(tableSpacing.row), data = rcTuning[10] }
