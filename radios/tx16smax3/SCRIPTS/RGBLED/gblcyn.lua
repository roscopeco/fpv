...
-- local BASE_LED_R, BASE_LED_G, BASE_LED_B = 0, 0, 255    -- Blue
-- local BASE_LED_R, BASE_LED_G, BASE_LED_B = 255, 255, 0  -- Yellow
local BASE_LED_R, BASE_LED_G, BASE_LED_B = 0, 255, 255  -- Cyan (Aqua)
-- local BASE_LED_R, BASE_LED_G, BASE_LED_B = 255, 0, 255  -- Magenta (Pink)
-- local BASE_LED_R, BASE_LED_G, BASE_LED_B = 255, 165, 0  -- Orange
-- local BASE_LED_R, BASE_LED_G, BASE_LED_B = 128, 0, 128  -- Purple
-- local BASE_LED_R, BASE_LED_G, BASE_LED_B = 191, 255, 0  -- Lime
-- local BASE_LED_R, BASE_LED_G, BASE_LED_B = 64, 224, 208 -- Turquoise
-- local BASE_LED_R, BASE_LED_G, BASE_LED_B = 255, 20, 147 -- Deep Pink
